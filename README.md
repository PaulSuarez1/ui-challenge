...
Note that the comp shows a mobile view at a width of 480 pixels, but that the width of the containers between the 960-pixel breakpoint and 480 pixels can (and probably should!) utilize the entire screen width.
...
- Create a repository called ***ui-challenge*** for your work.
